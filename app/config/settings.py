...
def validate_settings() -> bool:
    ...
    if not settings.SPOTIFY_CLIENT_ID:
        logger.warning("SPOTIFY_CLIENT_ID is not set. Spotify features will not work.")

    if not settings.OPENWEATHER_API_KEY:
        logger.warning("OPENWEATHER_API_KEY is not set. Weather context features will be limited.")
